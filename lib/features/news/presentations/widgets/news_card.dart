...
class NewsCard extends StatelessWidget {
                          ...
                          children: [
                            ...
                            Text(
                              article.displayDate != null
                                  ? AppDateFormats.dayMonthYearTime.format(
                            ...
                            Row(
                              children: [
                                ...
                                _buildActionButton(
                                  ...
                                  onTap: onDislike,
                                  isActive:
                                      article.currentUserVote == 'DOWNVOTE',
  ...
  Widget _buildActionButton({
    ...
    return GestureDetector(
                    ...
                    if (isActive)
                      Icon(activeIcon, size: 22, color: activeColor)
                          ...
                          .scale(
                            ...
                            duration: 350.ms,
                            curve: Curves
                                .easeOutBack, // Легке вистрибування контуру
                          )
        ...
        .animate(key: ValueKey('${activeIcon.codePoint}_$isActive'))
        .scale(
